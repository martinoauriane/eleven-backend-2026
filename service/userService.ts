...
class UserService {
  ...
  async addMessage(conversationId: number, type:string, message:string, senderId: number,){
    return await userStore.addMessage(conversationId, type, message, senderId);
  }
